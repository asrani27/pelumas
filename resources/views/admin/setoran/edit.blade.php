    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-clipboard"></i> Edit setoran</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            
            <form class="form-horizontal" action="/superadmin/setoran/edit/{{$data->id}}" method="post">
                @csrf
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="nominal" class="form-control" value="{{$data->nominal}}" onkeypress="return hanyaAngka(event)"/>
                    </div>
                  </div>
